#!/usr/bin/env python3
"""
Doc1 first baseline: Few-shot + Doc1 + Question.
"""
...
def inference_docfirst(model, tokenizer, question, doc1, max_new_tokens=30, device="cuda"):
    ...
    # Build full prompt (fewshot + doc1 + question)
    full_prompt = part_A + part_B + part_D
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Doc1 first baseline experiment")
    ...
    print("=" * 70)
    print("DOC1 FIRST BASELINE (Few-shot + Doc1 + Question)")
    print("=" * 70)
    ...
    output_file = os.path.join(args.output_dir, f"docfirst_useful_{timestamp}.csv")
