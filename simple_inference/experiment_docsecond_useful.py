#!/usr/bin/env python3
"""
Doc2 second baseline: Few-shot + Doc2 + Question.
"""
...
def inference_docsecond(model, tokenizer, question, doc2, max_new_tokens=30, device="cuda"):
    ...
    # Build full prompt (fewshot + doc2 + question)
    full_prompt = part_A + part_C + part_D
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Doc2 second baseline experiment")
    ...
    print("=" * 70)
    print("DOC2 SECOND BASELINE (Few-shot + Doc2 + Question)")
    print("=" * 70)
    ...
    output_file = os.path.join(args.output_dir, f"docsecond_useful_{timestamp}.csv")
