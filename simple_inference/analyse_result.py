...
def find_latest_csv(experiments_dir, experiment_name):
    ...
    Args:
        ...
        experiment_name: 实验名称（如 'dimension5', 'layerwise5'）
...
def main():
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="""
示例用法:
  python analyse_result.py dimension5 hiddenstate5 layerwise5 natural_useful part2_useful natural_empty
  python analyse_result.py layerwise5 part2_useful natural_useful
        """
    )
    parser.add_argument('experiments', nargs='+', 
                        help='实验名称列表 (如 dimension5, hiddenstate5, layerwise5, natural_useful, etc.)')
    parser.add_argument('--dir', type=str, default='./simple_inference/experiments',
    ...
    if results_summary:
        ...
        print("=" * 100)
        print()
        print(f"{'Experiment':<20} {'Samples':<10} {'Exact Match':<20} {'Contain Match':<20}")
        print("-" * 100)
        ...
        for exp_name in experiment_names:
            if exp_name in results_summary:
                ...
                print(f"{exp_name:<20} {results['total']:<10} "
