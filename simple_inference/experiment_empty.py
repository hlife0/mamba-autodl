...
def inference_empty(model, tokenizer, question, max_new_tokens=30, device="cuda"):
    ...
    # Build full prompt (no documents)
    full_prompt = part_A + part_D
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Empty baseline experiment")
    ...
    print("=" * 70)
    print("EMPTY BASELINE (Few-shot + Question only)")
    print("=" * 70)
    ...
    output_file = os.path.join(args.output_dir, f"empty_{timestamp}.csv")
