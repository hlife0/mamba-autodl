...
def skip_last_layer_hybrid_logic(ssm_fast_stack, ssm_slow_stack, skip_last_layers=3):
    """
    ...
    Args:
        ...
        skip_last_layers: Number of last layers to use fast cache (default: 3)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--skip_last_layers', type=int, default=3, help='Number of last layers to use fast cache')
